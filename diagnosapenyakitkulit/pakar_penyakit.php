...
<br />
<div class="title">Pengolahan Data Tipe Penyakit Kulit </div>
<br />
...
<?php  $jmldata= mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit")); echo "<center style=text-decoration:blink>Terdapat <b>$jmldata</b> record penyakit</center>";?>
<br>
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#007FFF">
  <tr bgcolor="#0066CC" align="center">
    ...
    <td width="690"><b><font color="white" size=3>Tipe Penyakit Kulit </font></b></td>
...
$no=0;
$qlog = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit ORDER BY kode_penyakit ASC LIMIT $posisi,$batas");
...
$no++;
  ...
  <?php
$jmldata = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit"));
...
if ($act=="berhasil"){?>
<div class="text_area" align="justify">      
<br /><div class="title">Data Tipe Penyakit Kulit Berhasil Disimpan</div>
<br />
<form action="?page=4&act=caripenyakit" method="post">
<table align="center" cellpadding="5" cellspacing="0">
...
elseif ($act=="editpenyakit"){
	...
	$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit WHERE kode_penyakit='$kode_penyakit'");
	$data = mysqli_fetch_array($qry);
	
?>
<br>
<div class="text_area" align="justify">
<div class="title">Ubah Data Tipe Penyakit Kulit</div>
<br>
...
elseif ($act=="aceditpenyakit"){
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE penyakit SET nama_penyakit='$nama_penyakit', definisi='$definisi', pengobatan='$pengobatan' , pencegahan='$pencegahan' WHERE kode_penyakit='$kode_penyakit'");
...
<br>
<div class="text_area" align="justify">
<div class="title">Detail Tipe Penyakit Kulit <?php echo $data['nama_penyakit'];?></div>
<br>
<table width="100%">
<tr>
    <td colspan="3"><hr color="#AAAAAA"></td>
  ...
  <tr>
    <td class="subtitle" valign="top">Jenis Kulit </td>
    <td valign="top">:</td>
...
elseif ($act=="hapuspenyakit"){
  $kode_penyakit = $_GET['kode_penyakit'];
  if(mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM relasi_penyakit_gejala WHERE kode_penyakit='$kode_penyakit'")) < 1){	
	if ($kode_penyakit != ""){
		mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM penyakit WHERE kode_penyakit='$kode_penyakit'");
		echo "<meta http-equiv=\"refresh\" content=\"0; url=pakar_index.php?page=4&act=berhasil\">";
	}
	else {
...
<div class="text_area" align="justify">      
<br />
<div class="title">Tambah Data Tipe Penyakit Kulit</div>
<br />
...
elseif ($act=="actambahpenyakit"){
	...
	$pengobatan = $_POST['pengobatan'];
	$pencegahan = $_POST['pencegahan'];
	$cek = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit");
	$jumlah = mysqli_num_rows($cek);
	$id = $jumlah+1;
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO penyakit  (kode_penyakit, nama_penyakit, definisi, pengobatan, pencegahan) VALUES  ('$kode_penyakit','$nama_penyakit','$definisi','$pengobatan','$pencegahan')");
		echo "<meta http-equiv=\"refresh\" content=\"0; url=?page=4&act=berhasil\">";
}
elseif($act=="caripenyakit"){
  @$nama_penyakit = $_POST['nama_penyakit'];
  $cari=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit WHERE nama_penyakit='$nama_penyakit'");
  $jumlah=mysqli_num_rows($cari);
  if($jumlah<1){
  ?>
  <div class="text_area" align="justify">      
<br />
<div class="title">Data Tipe Penyakit Kulit Tidak Ditemukan</div>
<br />
  <form action="?page=4&act=caripenyakit" method="post">
<table align="center" cellpadding="5" cellspacing="0">
<tr>
  ...
  ?>
<div class="text_area" align="justify">      
<br /><div class="title">Data Tipe Penyakit Kulit Ditemukan</div>
<br />
<form action="?page=4&act=caripenyakit" method="post">
<table align="center" cellpadding="5" cellspacing="0">
<tr>
...
<table border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666">
  <tr bgcolor="#0066CC" align="center">
    <td width="340"><b><font color="white" size=3>Tipe  Penyakit Kulit </font></b></td>
    <td colspan="3"><b><font color="white" size=3>Proses</font></b></td>
    </tr>
  <?php

	
	$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit WHERE nama_penyakit='$nama_penyakit' ");
