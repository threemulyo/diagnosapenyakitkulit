...
function koneksi_db(){
		...
		$link=($GLOBALS["___mysqli_ston"] = mysqli_connect($host, $user, $password));
...
function footer_web()
	  ...
	  ?>
	  <center>
 STIMIK NUSA MANDIRI 2020 <br /> <br /> Sistem Pakar Diagnosa Penyakit Kulit </br>
       </center>
	  <?php
	  }
...
<ul id="menu-kiri" class="topmenu">
	...
	<li class="topmenu"><a href="pakar_index.php?page=4&current4=current&act=tampilpenyakit" class="<?php echo $current4;?>">Daftar Jenis Penyakit<img src="images/menu/blue_circle - document text.png" alt="Tipe Penyakit Paru" width="24" height="24" align="absmiddle"/></a></li>
