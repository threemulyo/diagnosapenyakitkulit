...
if( isset($_POST['tombol'])) {
   if($_SESSION) {
    ...
    $cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_pakar WHERE username='$username' and password='".md5($_POST['passwordlama'])."'"));
	
	if ($cek>0){
	   $qry= mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE data_pakar SET password='".md5($_POST['passwordbaru'])."',  
