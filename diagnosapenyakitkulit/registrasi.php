...
<tr>
  ...
  <tr>
    ...
    <td valign="bottom" ><span id="sprytextfield7">
      <input name="username" type="text" size="25" maxlength="30"/>
  ...
  <tr>
	...
	</span><span class="selectRequiredMsg"><img src="images/cancel_f2.png"width="10" height="10"> Usia harus dipilih.</span></span>    </td>
  </tr>
  <tr>
    <td>Jenis Kelamin</td>
    <td>:</td>
  ...
  <!--<tr>
	...
	<img src="captchasecurityimages.php?width=120&height=40&character=4" /><br /><br /><input id="security_code" name="security_code" type="text" size="12"/>
	...
	<span class="textfieldMaxCharsMsg"><img src="images/cancel_f2.png"width="10" height="10"> Angka harus diisi dengan benar.</span></td>
  </tr>-->
  <tr>
