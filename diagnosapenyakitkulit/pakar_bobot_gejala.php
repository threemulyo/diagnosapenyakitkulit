...
<tr>
  ...
  <tr>
    <td width="60%" class="subtitle">Tipe Penyakit Kulit</td>
  </tr>
  <tr>
    <td>
      <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
        <option value="">[ Tipe Penyakit Kulit ]</option>
        <?php
  ...
  <tr>
   ...
   $qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM relasi_penyakit_gejala,gejala where relasi_penyakit_gejala.kode_penyakit='$kode_penyakit' AND relasi_penyakit_gejala.kode_gejala=gejala.kode_gejala");
	$a = 0;
...
elseif($act=="simpanbobot"){
	...
	if ($total==100){
		...
		for($i = 0; $i < $jum; ++$i){
			$qryr = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE  relasi_penyakit_gejala SET bobot='$bobot[$i]' WHERE kode_penyakit='$kode_penyakit' AND kode_gejala='$kode_gejala[$i]'");
