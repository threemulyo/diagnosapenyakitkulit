...
if ($act=="pertanyaan"){
	...
	if($status=='user'){
	    ...
	    $qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_user WHERE username='$username'");
	    $cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_user WHERE username='$username'"));
		}
		else {
		  $qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_pakar WHERE username='$username'");
	      $cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_pakar WHERE username='$username'"));
		}
...
if ($act=="ubah"){
  function clean($str) {
	...
	if($status=='user'){
	    ...
	    $cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_user WHERE username='$username' and jawaban='".md5($_POST['jawaban'])."'"));
		}
		else {
		  
	      $cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_pakar WHERE username='$username' and jawaban='".md5($_POST['jawaban'])."'"));
		}
...
if ($act=="acubah"){
	...
	if($status=='user'){
	    ...
	    $qry= mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE data_user SET password='".md5($_POST['password'])."' WHERE username='$username'");
	 
		}
		else {
		  $qry= mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE data_pakar SET password='".md5($_POST['password'])."' WHERE username='$username'");
