...
<?php  $jmldata= mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala")); echo "<center style=text-decoration:blink>Terdapat <b>$jmldata</b> record gejala</center>";?>
...
$no=0;
$qlog = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala ORDER BY kode_gejala ASC LIMIT $posisi,$batas");
...
?>
  ...
  <?php
$jmldata = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala"));
...
elseif ($act=="editgejala"){
	...
	$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala WHERE kode_gejala='$kode_gejala'");
...
<tr>
  ...
  <tr>
    ...
    <td><select name="kode_induk_ya" id="kode_induk_ya">
				...
				$qryp = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala where kode_gejala!='$ya'");
  ...
  <tr>
    ...
    <td><select name="kode_induk_tidak" id="kode_induk_tidak">
				...
				$qryp = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala where kode_gejala!='$tidak'");
				while($datap = mysqli_fetch_array($qryp)){
					echo "<option value='$datap[kode_gejala]'>[$datap[kode_gejala]] $datap[nama_gejala]</option>";
				}
				?>
...
elseif ($act=="aceditgejala"){
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE gejala SET nama_gejala='$nama_gejala',kode_induk_ya='$kode_induk_ya',kode_induk_tidak='$kode_induk_tidak' WHERE kode_gejala='$kode_gejala'");
	echo "<meta http-equiv=\"refresh\" content=\"0; url=pakar_index.php?page=5&act=berhasil\">";
}
elseif ($act=="hapusgejala"){
  $kode_gejala = $_GET['kode_gejala'];
  
  if(mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM relasi_penyakit_gejala WHERE kode_gejala='$kode_gejala'")) < 1){	
	if ($kode_gejala != ""){
		mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM gejala WHERE kode_gejala='$kode_gejala'");
		echo "<meta http-equiv=\"refresh\" content=\"0; url=pakar_index.php?page=5&act=berhasil\">";
	}
	else {
 ...
 <tr>
  ...
  <tr>
    ...
    <td><select name="kode_induk_ya" id="kode_induk_ya">
				...
				$qryp = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala");
				while($datap = mysqli_fetch_array($qryp)){
					echo "<option value='$datap[kode_gejala]'>[$datap[kode_gejala]] $datap[nama_gejala]</option>";
				}
				?>
...
elseif ($act=="actambahgejala"){
	...
	$cek = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala");
	$jumlah = mysqli_num_rows($cek);
	$id = $jumlah+1;
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO gejala  (kode_gejala, nama_gejala, kode_induk_ya, kode_induk_tidak) VALUES  ('$kode_gejala','$nama_gejala','$kode_induk_ya', '$kode_induk_tidak')");
...
elseif($act=="carigejala"){
  $nama_gejala = $_POST['nama_gejala'];
  $cari=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala WHERE nama_gejala='$nama_gejala'");
...
<br><table border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666">
  ...
  <?php
$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM gejala WHERE nama_gejala='$nama_gejala' ");
