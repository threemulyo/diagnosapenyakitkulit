...
<?php
	...
	$cek_hasil=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM hasil_diagnosa WHERE  username='$username'"));
...
$username=$_GET['u'];
$no=0;
$qlog = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM hasil_diagnosa WHERE username='$username' ORDER BY tanggal_diagnosa DESC");
...
?>
  ...
  <tr class="<?php if($no%2==1) echo "isitabelganjil"; else echo "isitabelgenap";?>">
	...
	$dnama = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM data_user WHERE username='$username'");
    $nama = mysqli_fetch_array($dnama);
	
	echo $nama['nama_user'];?></td>
    <td>
			<?php 
				$qpenyakit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM penyakit WHERE kode_penyakit='$data[kode_penyakit]'");
...
<tr>
  ...
  <tr>
    ...
    <td>
    	<?php
		// $sql_gejala = "select * from gejala a INNER JOIN relasi_penyakit_gejala b ON a.kode_gejala = b.kode_gejala
		// WHERE b.kode_penyakit = '$data[kode_penyakit]'";
...
$id=$_GET['id'];
$username=$_GET['u'];
$qry = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM hasil_diagnosa, data_user WHERE  id_diagnosa='$id' AND hasil_diagnosa.username=data_user.username");
$data = mysqli_fetch_array($qry);
?>
<div class="text-area-user" align="justify">  
<br>
...
<tr>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="top">Hasil kesimpulan diagnosa, anda tidak mengalami jenis penyakit, disebabkan tidak ada gejala yang anda alami.</td>
  </tr>
